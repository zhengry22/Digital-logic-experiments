...
HD_PWD='D:/Digital-logic-experiments/Revision/Revision.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PasswordLock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PasswordLock.tcl -notrace
