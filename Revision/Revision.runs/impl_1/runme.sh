...
HD_PWD='D:/Digitial_Logic_Lab/Revision/Revision.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder1.tcl -notrace
